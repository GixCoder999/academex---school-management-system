...
module.exports = (app)=> {
    ...
    app.get('/classes/' ,async (req,res) =>
    {
        ...
        const query = 'SELECT s.subject_id as subject_name ,t.name as tname ,ta.class_id FROM subjects s , teachers t,teacher_assignments ta WHERE t.teacher_id=ta.teacher_id and ta.subject_code = s.subject_id AND ta.class_id = ?'
